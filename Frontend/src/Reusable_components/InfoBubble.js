    ...
    <div className="PC_container">
      {!Layout ? (
        ...
        >
          ...
          >
            <span className="desktop-message">Select a file on the left by clicking the title tag</span>
            <span className="mobile-message">Select a file from above by clicking the title tags</span>
          </motion.div>
        </motion.div>
      ) : Layout === "AboutMe" ? (
        <AnimatePresence>
